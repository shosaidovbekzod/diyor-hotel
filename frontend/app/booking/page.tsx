...
const bookingPageCopy = {
  ...
  uz: {
    ...
    sortLabel: "Xonalarni saralash",
    recommended: "Tavsiya etilgan",
    priceLowHigh: "Narx: arzonidan qimmatga",
    priceHighLow: "Narx: qimmatidan arzoniga",
    largestSpace: "Eng katta maydon",
    availableOnly: "Faqat mavjud toifalar",
    availableSummary: "Hozir mavjud",
    soldOutSummary: "Band bo'lganlar",
